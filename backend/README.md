...
## Project Structure
    ...
    ├── testapiautostorybo_121533  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_121533`
...
2. Clone this repo and `cd testapiautostorybo_121533`
